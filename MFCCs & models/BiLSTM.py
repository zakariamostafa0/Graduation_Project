...
DATA_PATH = "G:/FCAI/Python Projects/Stuttering-Classification/data14_improved4classes.json"
...
def build_model(input_shape):
    ...
    # 2 LSTM layers
    model.add(keras.layers.Bidirectional(keras.layers.LSTM(128, kernel_regularizer=keras.regularizers.l2(0.01)),
